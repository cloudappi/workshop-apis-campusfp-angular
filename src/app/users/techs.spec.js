...
describe('users component', function () {
  beforeEach(function () {
    angular
      .module('fountainTechs', ['app/users/users.html'])
  ...
  it('should render 3 elements <fountain-tech>', angular.mock.inject(function ($rootScope, $compile, $httpBackend) {
    $httpBackend.when('GET', 'app/users/users.json').respond(techsJson);
    var element = $compile('<fountain-users></fountain-users>')($rootScope);
    $httpBackend.flush();
    $rootScope.$digest();
